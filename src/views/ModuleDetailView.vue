  ...
  <template v-if="module">
    <AppPage>
      ...
      >
        <template #extra>
          <Tag
            v-if="moduleProgress.wrongCount > 0"
            color="error"
            :bordered="false"
          >
        ...
        <Row :gutter="[24, 16]" align="middle">
          <Col :xs="24" :md="12">
            <Flex vertical gap="8px">
              ...
              <Progress
                ...
                :show-info="false"
                :stroke-color="
                  moduleProgress.percent === 100 ? '#52c41a' : '#1677ff'
                "
              />
            </Flex>
          </Col>
          <Col :xs="12" :md="6">
            <Statistic
              ...
              :value="moduleProgress.totalQuestions"
            />
          </Col>
          <Col :xs="12" :md="6">
            <Statistic
